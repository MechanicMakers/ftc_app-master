...
@Autonomous(name="Autonumose_Competition_1_Red_1", group="Autonomous")

public class Autonumose_Competition_1_Red_1 extends OpMode {
    ...
    public void start() {
        ...
        else if(robot.RJCS.blue() > robot.RJCS.red()) {
